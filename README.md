...
- (Laptop) [xbacklight](https://www.x.org/archive/X11R7.5/doc/man/man1/xbacklight.1.html) for adjusting brightness on laptops (disabled by default also ['xf86-video-intel'])
...
```
git clone https://github.com/saurabhinabys/material-awesome.git ~/.config/awesome
```
